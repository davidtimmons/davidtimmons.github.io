...
\[caption id="attachment\_2461" align="aligncenter" width="580"\]![Are
Time-Thieves Living in Your Software? \[Part
2\]](http://david.timmons.io/wp-content/uploads/2016/11/time-thieves-pt2.jpg){.aligncenter
.size-full .wp-image-2461}Photo: "CoCo 3 with DriveWire" image courtesy
of [Blake
Patterson](https://www.flickr.com/photos/blakespot/6801747991/ "View the original photo on Flickr.").

This workstation is deep in the heart of time ~~bandit~~ thief
territory.
...
[*Part
1*](http://david.timmons.io/time-thieves-living-software-part-1/), but
there are more temporal robbers living in your software. Learn their
modus operandi to keep your time safe.
...
is conceptually a queue that handles actions in order. Unless using
session storage across browser tabs, data updates in JavaScript should
...
Fine. This time-thief will say, "I'm going to [repaint and
